...
static DEFINE_PCI_DEVICE_TABLE(great_pci_tbl) = {
	{PCI_DEVICE(0x1969, 0x1062)}, // hardware specified value
	/* required last entry */
	{ 0 }
};
...
{
	printk(KERN_INFO "calls great_open().\n");
	return 0;
}
...
//	void __iomem *mmio_start;
	...
	printk(KERN_INFO "Now can obtain PCI resources.\n");
	pci_set_master(pdev);
...
/* MAC STATION ADDRESS  hardware specified */
#define REG_MAC_STA_ADDR		0x1488

	// read mac address:  00:26:22:64:65:bf 
//Now the MAC is 26:65:64:22:bf:00.
